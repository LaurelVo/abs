...
{
		var name_val=document.getElementById("room_text"+no).value;
		var country_val=document.getElementById("status_text"+no).value;
		var age_val=document.getElementById("period_text"+no).value;

		document.getElementById("room_row"+no).innerHTML=name_val;
		document.getElementById("status_row"+no).innerHTML=country_val;
		document.getElementById("period_row"+no).innerHTML=age_val;
