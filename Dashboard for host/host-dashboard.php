...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="host_manager.css">
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />  
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>  
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
    <script type="text/javascript" src="./js/host-table.js"></script>
    <title>Dashboard for Host</title>
...
<body>
    ...
    <h4 class="welcome">Welcome Host</h4>
    <h4 class="overview">Manage House</h4>
    ...
    <h4 class="reviewmana">Manage Request</h4>
    ...
    <h4 class="reviewmana">Review List</h4>
